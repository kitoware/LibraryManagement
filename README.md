...
This project is a simple **Library Management System** implemented in Java using Gradle as the build tool.  This was built as a study tool for my classmates in CS3140 (SDE) at UVA. The system supports the following features:
